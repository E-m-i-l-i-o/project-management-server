...
router.get('/projects', (req, res, next) => {
    Project.find()
        .populate("tasks") //you want to populate with the tasksArr from the project.model.js
        .then(response => {
            res.json(response)
        })
        .catch(err => {
...
router.delete('/projects/:projectId', (req, res, next) => {
    ...
    Project.findByIdAndRemove(projectId)
        .then(deletedProject => {
            return Task.deleteMany({ _id: { $in: deletedProject.tasks } }); //I delete all tasks associated with the project I deleted
        })
